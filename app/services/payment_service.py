...
class PaymentService:
    ...
    def initiate_deposit(
        ...
        *,
        ...
        if settings.payments_mode == "paystack":
    ...
    def verify_webhook_signature(raw_body: bytes, signature: str | None) -> bool:
        ...
        if not signature:
            return False
        digest_sha512 = hmac.new(secret.encode("utf-8"), raw_body, hashlib.sha512).hexdigest()
        digest_sha256 = hmac.new(secret.encode("utf-8"), raw_body, hashlib.sha256).hexdigest()
